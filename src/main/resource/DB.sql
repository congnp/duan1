...
VALUES('89986A51-E76F-4EC7-AF03-AAD9E343683C','E1A19394-367D-43FE-AD02-E7E017A7E835','EE32C19A-A487-4171-BF9D-FB910CE86C00','8ABF85C6-A872-49CA-9C1A-B51C68B745D6',
'BA02C1BF-3B37-477C-B3B5-7C887C981071', 20, 150000, N'ĐỐT KHÔNG CHÁY, CẮT KHÔNG RÁCH, SÚNG BẮN KHÔNG THỦNG', 1, '10-11-2022','11-11-2022')
SELECT * FROM SanPham
SELECT * FROM LoaiSP
SELECT * FROM ChatLieu
SELECT * FROM Size
...
VALUES('053176A3-D490-465B-B2CF-96CB7EDE94CE',N'ND01','nv1',123,N'Lê Thị Nguyệt Mai',N'Nữ',
'1-12-2003','danhpnph26382@fpt.edu.vn','0932343783',N'Hồ Tùng Mậu','001304656874',1,'10-11-2022','11-11-2022')
INSERT INTO NguoiDung(IdCV,MaND,TenTK,MatKhau, HoVaTen, GioiTinh, NgaySinh, Email, Sdt, DiaChi, [CCCD/CMT], TinhTrang, NgayTao, NgaySua)
VALUES('2480E083-D977-4F91-A041-27F58881C2BF',N'ADMIN','admin',123,N'Nguyễn Thúy Hằng',N'Nữ',
...
VALUES('AB7372A0-1F64-424B-9F29-88487CE81622','A01',N'ẢNH Áo POLO',NULL)
