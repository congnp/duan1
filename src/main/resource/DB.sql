...
VALUES('E85F3DAA-9B88-4426-A577-82858538C26B','0E7E41D8-74F4-4D0E-AFCD-65C9E5A3D686','126371F5-941F-420F-9C04-686A6F1B0489','D4C9746D-394F-432A-9532-11EA9F1C5905',
'678D1090-A48D-4275-A903-FCA36FBFE0F4', 20, 150000, N'CẮT KHÔNG RÁCH, SÚNG BẮN KHÔNG THỦNG', 1, '10-11-2022','11-11-2022')
SELECT * FROM SanPham
SELECT * FROM LoaiSP
SELECT * FROM ChatLieu
SELECT * FROM Size
...
VALUES('5CCEEB78-3553-4EB1-BAE0-974FF74DBE20',N'ND01','nv1',123,N'Lê Thị Nguyệt Mai',N'Nữ',
'1-12-2003','danhpnph26382@fpt.edu.vn','0932343783',N'Hồ Tùng Mậu','001304656874',1,'10-11-2022','11-11-2022')
INSERT INTO NguoiDung(IdCV,MaND,TenTK,MatKhau, HoVaTen, GioiTinh, NgaySinh, Email, Sdt, DiaChi, [CCCD/CMT], TinhTrang, NgayTao, NgaySua)
VALUES('E6CC44A8-2C0B-49C3-9B70-4B8134B2FF05',N'ND02','admin',123,N'Phan Ngọc Danh',N'Nam',
