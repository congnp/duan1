 ...
 * @author pdanh
 */
public class SRM_KhachHang extends javax.swing.JFrame {

    /**
     * Creates new form SRM_KhachHang
     */
    public SRM_KhachHang() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SRM_KhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SRM_KhachHang().setVisible(true);
            }
        });
    }
