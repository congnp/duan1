...
public class SRM_BanHang extends javax.swing.JFrame {
    ...
    private final IChucVuService iCV = new ChucVuService();
    ...
    private void initComponents() {
        ...
        QL_BanHangLayout.setHorizontalGroup(
            ...
            .addGroup(QL_BanHangLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(DonHang, javax.swing.GroupLayout.DEFAULT_SIZE, 396, Short.MAX_VALUE))
        );
        ...
        tbl_nd_DangLam.setModel(new javax.swing.table.DefaultTableModel(
            ...
            boolean[] canEdit = new boolean [] {
                true, true, true, true, true, true, true, true, true, true, false, true, true, false
            };
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(jScrollPane12, javax.swing.GroupLayout.DEFAULT_SIZE, 1009, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void showND() {
        ...
        txt_nd_NgayTao.setText(tbl_nd_DangLam.getValueAt(row, 11).toString());
...
//    }
    ...
    private void loadCV() {
        String Header[] = {"id", "Ma ChucVu", "Ten ChucVu"};
        modelCV = new DefaultTableModel(Header, 0);
        modelCV.setRowCount(0);
        tbl_cv.setModel(modelCV);
        int stt = 1;
        for (ChucVu x : iCV.getAll()) {
            modelCV.addRow(new Object[]{x.getIdCV(), x.getMaCV(), x.getTenCV()});
        }
    }
