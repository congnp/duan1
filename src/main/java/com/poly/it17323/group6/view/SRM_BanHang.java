...
//Van
    ...
    private void initComponents() {
            ...
            .addGroup(ThongTinLayout.createSequentialGroup()
                ...
                .addGroup(ThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(ThongTinLayout.createSequentialGroup()
                        ...
                        .addGap(60, 60, 60)
                        .addComponent(lblMaHD, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                        .addGap(63, 63, 63)
        ...
        PN_QR.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel5.add(PN_QR, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 200, 210));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(lblHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(8, 8, 8))
        );
        ...
        jLabel25.setText("SỐ HÀNG ĐỔI TRẢ");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lblHangHuy, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblHangHuy, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        tblDonHangHuy.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã HĐ", "Mã ND", "Ngày đặt", "Ngày trả", "Tổng tiền", "Lý do đổi trả"
            }
        ) {
            boolean[] canEdit = new boolean [] {
   ...
   public QLNguoiDungResponse getND(QLNguoiDungResponse nguoiDungResponse) {
    ...
    private void tblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamMouseClicked
        ...
        loadDataGH(iBH.getAll_HDCTByIDHD(HD.getIdHD()));
        tinhTien(HD);
        if (!iBH.getAll_HDCTByIDHD(iBH.getAll_HD().get(tblHoaDon.getSelectedRow()).getIdHD()).isEmpty()) {
            xoa.setEnabled(true);
    ...
    private void btnThanhToanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThanhToanMouseClicked
        if (cboPthuctt.getSelectedIndex() == 0 && txtTienKhachDua.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui long nhap tien khach dua");
            return;
        }
    ...
    private void txtTimKiemCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtTimKiemCaretUpdate
        loadDataSP(iBH.getAll_ByName("%" + txtTimKiem.getText() + "%"));
...
//        kh.setNgaySua(txt_kh_NgaySua.getText().trim());
    ...
    private javax.swing.JPanel PN_QR;
    ...
    private void loadDataSP(List<ChiTietSanPham> lstCTSP) {
    ...
    private void initWebcam() {
        ...
        PN_QR.add(panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 200, 210));
    ...
    public void run() {
        do {
            ...
            BinaryBitmap bitmap = new BinaryBitmap(new HybridBinarizer(source));//Lấy source
